...
def run_forge_pipeline(bundle: dict, has_gpu: bool = False) -> dict:
    ...
    try:
        ...
        integrity_verifier.verify(cache_dir, asset)
        cache_manager.write_cache_manifest(model_id, "main", {}, {"model_id": model_id})
        ...
        def _tokenize_for_trainer(examples):
            ...
            for i in range(batch_size):
                ...
                texts.append(text)
            encoded = prepared.tokenizer(texts, truncation=True, padding="max_length",
        ...
        if peft_result["peft_model"] and hasattr(peft_result["peft_model"], "save_pretrained"):
            ...
            results["artifacts"].extend([str(output_dir / "adapter_model.safetensors"),
